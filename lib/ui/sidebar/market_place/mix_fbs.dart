...
class MixFbsPage extends StatelessWidget {
  int? recordPIN, recorNumber;
  MixFbsPage({super.key, this.recordPIN, this.recorNumber});
  @override
...
class _MarketPageState extends State<MarketPages>
  ...
  TextEditingController fromController =
      TextEditingController(text: 'EGORKA_SC');
  TextEditingController toController =
      TextEditingController(text: 'Egorka_SBOR_FBS');
